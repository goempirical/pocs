var LotBox = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(LotList, { data: this.state.data, onLotDelete: this.handleLotDelete, onLotUpdate: this.handleLotUpdate, onRefresh: this.handleRefresh }),
			React.createElement(LotFormQuick, { onLotSubmit: this.handleLotSubmit }),
