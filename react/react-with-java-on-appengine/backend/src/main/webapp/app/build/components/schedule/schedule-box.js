var ScheduleBox = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(ScheduleList, { data: this.state.data, onLotDelete: this.handleLotDelete, onLotUpdate: this.handleLotUpdate, onRefresh: this.handleRefresh }),
