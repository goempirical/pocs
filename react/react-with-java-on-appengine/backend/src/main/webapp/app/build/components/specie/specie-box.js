var SpecieBox = React.createClass({
	displayName: 'SpecieBox',
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(SpecieList, { data: this.state.data, onLotDelete: this.handleLotDelete, onLotUpdate: this.handleLotUpdate, onRefresh: this.handleRefresh }),
