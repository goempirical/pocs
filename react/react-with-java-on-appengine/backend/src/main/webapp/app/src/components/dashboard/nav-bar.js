    ...
    return (
            <nav className="navbar navbar-default navbar-static-top" role="navigation" style={{marginBottom: '0'}} >
                <div className="navbar-header">
                    ...
                    <a className="navbar-brand" style={{background: 'white', width: '250px'}} href="#index.html">
                    	<img style={{maxWidth: '175px', marginTop: '-13px', marginLeft: '45px'}} src="build/dist/images/rsz_m2ingredients.jpg"/>
                    </a>
                </div>
                ...
                <div className="navbar-default sidebar" role="navigation">
                    <div className="sidebar-nav navbar-collapse">
                        <ul className="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#" onClick={this.showDashboard}><i className="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
                            <li>
                                <a href="#" onClick={this.showLotBox}><i className="fa fa-bar-chart-o fa-fw"></i> Lots</a>
                            </li>
                            <li>
                                <a href="#" onClick={this.showSpecieBox}><i className="fa fa-edit fa-fw"></i> Species</a> 
                            </li>
                            <li>
                                <a href="#" onClick={this.showScheduleBox} ><i className="fa fa-table fa-fw"></i> Schedule</a>
                            </li>
                            <li>
                                <a href="##"><i className="fa fa-wrench fa-fw"></i> Settings<span className="fa arrow"></span></a>
                            ...
                            <li>
                                <a href="##"><i className="fa fa-sitemap fa-fw"></i> Multi-Level Menu<span className="fa arrow"></span></a>
                                <ul className="nav nav-second-level">
                                    <li>
                            ...
                            <li>
                                <a href="##"><i className="fa fa-files-o fa-fw"></i> Admin<span className="fa arrow"></span></a>
                                <ul className="nav nav-second-level">
                                    <li>
