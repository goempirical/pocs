	      ...
	      <div className="lotBox">
	      	<div className="row">
	      		<div className="col-lg-12">
	      			<h1 className="page-header">Species</h1>
	      		</div>
	      	</div>
			<SpecieList data={this.state.data} onLotDelete={this.handleLotDelete} onLotUpdate={this.handleLotUpdate} onRefresh={this.handleRefresh} />
